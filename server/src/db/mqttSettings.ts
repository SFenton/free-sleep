...
import { MqttSettings, MqttSettingsSchema } from './mqttSettingsSchema.js';

const defaultData: MqttSettings = {
...
const file = new JSONFile<MqttSettings>(`${config.lowDbFolder}mqttSettingsDB.json`);
const mqttSettingsDB = new Low<MqttSettings>(file, defaultData);
